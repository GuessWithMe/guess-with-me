...
module.exports = shipit => {
  ...
  shipit.initConfig({
    ...
    production: {
      servers: 'ubuntu@ec2-18-224-148-199.us-east-2.compute.amazonaws.com',
      build: 'tsc'
    }
  });
  ...
  shipit.task('sync', ['default'], async () => {
    ...
    return shipit.remote(`NODE_ENV=production pm2 start index.js --node-args="-r tsconfig-paths/register"`, {
      cwd: `${targetDir}/src`
    });
  });
